...
string_test = ["!/usr/bin/ruby -w", 'puts "Hello, Ruby"', "=begin",
               "This is a multiline comment and con spwan as many lines as you", "like.", "=end", "@count # keeps track times page has been hit"]
