...
def test_average_lines_similarity():
    ...
    assert ap.average_lines_similarity(code_list,["../Examples/EventCandidatA.rb"])==('../Examples/EventCandidatA.rb',1,1)
    assert ap.average_lines_similarity(code_list,["../PastDatas/EventCandidatB.rb","../PastDatas/EventCandidatC.rb"])==('../PastDatas/EventCandidatC.rb', 1.0, 0.5)
